...
export class Storage {
   ...
   * @return {Promise<any>}     Returns a promise with the value of the given key
   */
   ...
   * @return {Promise<any>}       Returns a promise that resolves when the key and value are set
   */
   ...
   * @param  {string}       key the key to identify this value
   * @return {Promise<any>}     Returns a promise that resolves when the value is removed
   */
   ...
   * @return {Promise<void>} Returns a promise that resolves when the store is cleared
   */
  clear(): Promise<void> {
  ...
  /**
   * @return {Promise<number>} Returns a promise that resolves with the number of keys stored.
   */
  ...
  /**
   * @returns {Promise<string[]>} Returns a promise that resolves with the keys in the store.
   */
  keys(): Promise<string[]> {
   ...
   * @returns {Promise<void>} Returns a promise that resolves when the iteration has finished.
   */
