...
A one-time migration must be performed to move to a new, encrypted database.

First, follow the installation steps above to update to v3 and the `localForage-CordovaSQLiteDriver`.
